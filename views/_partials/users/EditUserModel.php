<div class="modal fade" id="EditUser" tabindex="-1" aria-labelledby="AddUserLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content shadow-lg rounded-4 bg-dark text-light">
      ...
      <form id="EditUserForm" class="needs-validation">
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control bg-white text-dark" id="edit-firstName" name="first_name" required />
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control bg-white text-dark" id="edit-lastName" name="last_name" required />
            ...
            <div class="col-md-6">
              ...
              <input type="email" class="form-control bg-white text-dark" id="edit-email" name="email" required />
            ...
            <div class="col-md-6">
              ...
              <input type="password" class="form-control bg-white text-dark" id="edit-password" name="pass" required />
            ...
            <div class="col-md-6">
              ...
              <input type="tel" class="form-control bg-white text-dark" id="edit-phone" name="phone" pattern="[0-9]{10,15}" required />
            ...
            <div class="col-md-6">
              ...
              <select id="edit-gender" name="gender" class="form-select bg-white text-dark" required>
